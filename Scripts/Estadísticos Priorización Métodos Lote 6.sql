 ...
 * Estadísticos Priorización Métodos
 */
...
begin
	...
	select superior_en_area_estandar
		...
		where substring(predio_numero_predial,1,5) = codigo_municipio
		group by 1
	);
	...
	execute 'create table estadisticos_priorizacion_predio_metodo_lote_6_' || codigo_municipio || ' as 
	(
